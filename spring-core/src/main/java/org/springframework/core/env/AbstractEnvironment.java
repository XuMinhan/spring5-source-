...
//	@Override
//	public Map<String, Object> getSystemProperties() {
//		// 创建一个新的 HashMap，并将 System.getProperties() 的内容复制到新的 HashMap 中
//		Map<String, Object> systemPropertiesCopy = new HashMap<>();
//		System.getProperties().forEach((key, value) -> systemPropertiesCopy.put((String) key, value));
